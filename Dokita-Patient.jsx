...
// ══════════════════════════════════════════════════════════════════════
const APPS_SCRIPT_URL = "https://script.google.com/1JUdzwa6EMLLmQx53I4MS07fhoV9BIAC-7ZGB320n7_U/exec";
      ...
      <div className="app">
        {screen==="login"
          ...
          : <>
              ...
              {tab==="home"    && <HomeTab    user={user} rdvs={rdvs} onBook={book} onTab={setTab}/>}
              {tab==="book"    && <BookTab    user={user} draft={draft} onDone={r=>{addRdv(r);setTab("rdvs")}} onBack={()=>setTab("home")}/>}
...
//  HOME
// ══════════════════════════════════════════════════════════════════════
function HomeTab({user,rdvs,onBook,onTab}){
  const next = rdvs[0];
  return(
    <div className="page">
      <div className="mb2">
      ...
      <div>
        ...
        {DEMO_HOSPITALS.slice(0,3).map(h=>{
...
//  BOOK (4 étapes)
// ══════════════════════════════════════════════════════════════════════
function BookTab({user,draft,onDone,onBack}){
